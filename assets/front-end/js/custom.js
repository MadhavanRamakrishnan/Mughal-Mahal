...
//     var remDish = $(this).attr('remDish');
//     var address = $('.custAddress:checked').val();
//     if (address == undefined) {
//         customtoastr(selectAddress, 'errorshow');
//         return false;
//     } else if (remDish == 0) {
...
//                 customtoastr(obj.error + " " + obj.message[0].min_order_amount + " KD.", "errorshow");
//                 return false;
//             } else {
...
//                     var obj = $.parseJSON(response);
//                     if (obj.success == 0) {
//                         customtoastr(restaurantTime, "errorshow");
//                         return false;
//                     } else if (address != undefined && payment != undefined) {
...
//                                     window.location.href = base_url + 'Home/orderDetails/' + obj.order_id;
...
//                                 else{
//                                     $("#loading-div-background").hide();
//                                     customtoastr("Order has been not place,please try again", "errorshow");
//                                 }
//                             }
//                         });
//                     } else {

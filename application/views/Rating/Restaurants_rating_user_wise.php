        ...
        <div class="tab-content">
            <div class="panel panel-default tab-pane tabs-up active" id="all">
                <div class="panel-body">
                    <ul class="activities-list list-unstyled nicescroll" tabindex="5002" style="overflow: hidden; outline: none;"><h3><?php echo $RestaurantName[0]->restaurant_name;?></h3>
                            ...
                            <div class="panel-body">
                               <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <?php if(is_array($Restaurantsrating) &&  count($Restaurantsrating)>0){
                                         
                                            foreach($Restaurantsrating as $key => $value){

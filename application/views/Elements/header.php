...
<head>
  ...
  <!--   <link rel="stylesheet" href="<?php //echo base_url(); ?>assets/css/plugins/bootstrap-datetimepicker/bootstrap-datetimepicker.css" /> -->
     <link rel="stylesheet" href="<?php echo base_url(); ?>assets/js/plugins/bootstrap-datetimepicker/datepicker3.css">
 ...
 <script src="<?php echo base_url(); ?>assets/js/bootstrap/bootstrap-toggle.min.js"></script>
    ...
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAaWqUMoAlFiTao-1cDOQTtckOyA43eWQ4&libraries=places"></script>

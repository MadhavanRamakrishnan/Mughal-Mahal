...
//            jQuery(".orderPopupOnlineorder").colorbox({
// inline: true,
// className: 'my-class',
// close: "Close"
// });

            jQuery(".topOrderButton").colorbox({
                inline: true,
                className: 'my-class',
                close: "Close"
            }); /**/

            jQuery(".minusDishpopUp").colorbox({
                inline: true,
                width: "80%",
                className: 'my-class',
                close: "Close"
    ...
    <link href="<?= base_url() ?>assets/front-end/css/style2.css?v=1.1" rel="stylesheet" type="text/css" />
    <script src="<?= base_url() ?>assets/front-end/js/custom/footer.js?v=1.5" type="text/javascript"></script>
    ...
    <div class="section" id="topSecion">
        <div class="container">
            ...
            <ul class="logSwitch usernotlogin">
                ...
                <li><?= (isset($userdata[0]->first_name) && !empty($userdata[0]->first_name)) ? ($userdata[0]->first_name." ".$userdata[0]->last_name) : ""; ?></li>
            </ul>
            <?php }else{?>
            ...
            <a href="#myModal" class="topOrderButton"><span><?= $this->lang->line('message_onlineorder') ?></span></a>
            <div id="myModal" class="modal default_popup">
                <!-- Modal content -->
                    ...
                    <div id="startorderonline" class="swForms fancybox-content" style="display: inline-block;">
                        ...
                        <div class="search_box">
                            ...
                            <div class="search_btn">
                                <input type="button" id="start_my_order" value="<?= $this->lang->line('start_my_order') ?>">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <a href="#cartPopup" class="cartLink">
                <div id="cartCount"><?= $this->cartItem; ?></div>
            </a>
            <?php } ?>

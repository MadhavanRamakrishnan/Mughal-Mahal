        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="post" action="<?php  echo site_url('Customers/editCustomers/'.$driv_data[0]->user_id);?>" enctype="multipart/form-data">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            ...
                            <div class="form-group">
                               <?php  
                                ...
                                else if($driv_data[0]->dob){
                                    $dob=date("m/d/Y",strtotime($driv_data[0]->dob));
                                }
                                else{
                                    $dob="";
                                } ?>
                                <label >Birth Date<i class="reustarred">*</i></label>
                                <input type="text" class="form-control" placeholder="Enter birth date" name="dob" value="<?php echo $dob; ?>" id="datepicker">
                        ...
                        <input type="hidden" name="cust_id" value="<?php echo $driv_data[0]->user_id ?>">
                    </form>
                </div>
            </div>
        </div>

                            ...
                            <tr>
                                <td valign="top" class="mcnTextBlockInner" style="padding-top: 9px;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
                                    ...
                                    <div class="mcnTextContent" style="padding: 0px 18px 9px;">
                                        <span style="color:#222222; font-weight: bold;">Hello</span> Manisha,
                                        
                                        <br>
                                        <span style="text-decoration: none; color:#222222;">
                                        <p>
                                            Thank you for registering.Now you can login through below credentials.
                                        <br>
                                        <br>
                                        <b>Email: </b>manishaKanazariya@gmail.com 
                                        <br>
                                        <b>Password: </b>Oneclick1@ 
                                        </p>
                                            <span style="text-decoration: none; color:#222222;">
                                         <a href="<?php echo "#"; ?>" ><button class="reset_btn" style=" background-color: #1f9640; border: none; border-radius:10px; color: white; padding: 10px 35px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin-top:20px">Login</button></a>
                                        </span>
                                            </a>
                                        </span><br><br>
                                    </div>

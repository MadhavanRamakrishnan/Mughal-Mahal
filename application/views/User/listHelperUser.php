    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="page-header f-right m-t-10">
                <a href="<?php echo site_url('User/addHelpersUser'); ?>" type="button" class="btn btn-primary ">Add Admin</a>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
          <div class="panel panel-default">
                <div class="panel-heading">Admin, Angel And Survivor List</div>

                <div class="panel-body table-responsive">
                    <div class="row m-t-10 m-b-10">
                        <div class="col-sm-6 col-lg-4 col-lg-offset-8">
                            <form action="<?php echo site_url('User/searchUser');?>" method="POST">
                    ...
                    <table class="table table-striped no-margn">
                        ...
                        <tbody>
                            <?php 
                                if(count($listuser)<1){
                            ?>
                                <tr><td colspan="6"><div align="center">No User Data</div></td></tr>
                            <?php    }else{

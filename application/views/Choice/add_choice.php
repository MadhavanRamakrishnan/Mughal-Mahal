        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="post" action="<?php  echo site_url('Choice/addChoice');?>" enctype="multipart/form-data">
                      <div id="clonecontainer"> 
                        <div id="clonedInput1" class="clonedInput">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control description" name="description[]" id="description" rows="3" placeholder="Enter Description"></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="button" id="Add" class="btn btn-primary clone" value=" +Add " />
                              <input type="button" id="remove" class="btn btn-primary remove" value=" -Remove " />

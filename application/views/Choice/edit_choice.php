                        ...
                        <div class="form-group">
                            ...
                            <option value="">Select Category Type</option>
                                ...
                                foreach ($categoryList as $key => $value){ 
                                    ...
                                    <option  value="<?php echo $value->choice_category_id ?>" <?php if ($value->choice_category_id == $choicedata[0]->fk_choice_category_id) echo 'selected' ;?>><?php echo $value->choice_category_name; ?>
                                    </option><?php 
                                } ?> 
                            </select>

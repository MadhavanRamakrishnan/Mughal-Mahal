    ...
    <div class="container clearfix">
      <div class="locationTop">
          ...
          <ul>
            ...
            <li>
              <a id="iframe2" href="#startorderonlinedata2" class="orderPopupOnlineorder"><?= $this->lang->line('change_preferences'); ?></a>
            </li>
      </div>
          ...
          <div class="contentSection wow fadeInUp" data-wow-duration="1s" data-wow-delay="0" style="visibility: visible; animation-duration: 2s; animation-name: fadeInUp;">
              ...
              <div class="tabs_wrapper">
                ...
                <ul class="tabs" id="category_tab">
                   ...
                   <a href="#tab1"><li rel="tab1">Offers</li></a>
                   <a href="#tab2"><li rel="tab2">Kings Feast for 4</li></a>
                   <a href="#tab3"><li rel="tab3">Recommended</li></a>
                   <a href="#tab4"><li rel="tab4">Whopper®</li></a>
                   <a href="#tab5"><li rel="tab5">Classic Burgers</li></a>
                   <a href="#tab6"><li rel="tab6">King Savers</li></a>
                   <a href="#tab7"><li rel="tab7">Add-Ons</li></a>
                   <a href="#tab8"><li rel="tab8">Beverages</li></a>
      ...
      <div class="rightMain" id="sidebar" >
          <div class="rightOut">
            <div class="sidebar__inner">
              ...
              <div class="rightTwo">
                  <div class="left">
                         <div class="tooltip"> <p>Paneer King Melt Combo  <img src="http://18.216.199.131/admin/assets/front-end/images/info.png" alt="">
              ...
              <div class="rightTwo rightThree">
                  <div class="left">
                           <div class="tooltip"><p>Crispy Chicken Supreme Combo <img src="http://18.216.199.131/admin/assets/front-end/images/info.png" alt=""></p><br/>   
                            <span class="tooltiptext">Info</span></div>                        
                              <div class="numbers-row">                                        
                                  <input type="text" name="numId" id="numId" value="1">
                               </div>                            

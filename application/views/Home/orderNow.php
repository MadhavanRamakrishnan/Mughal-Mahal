...
<div id="data">
  ...
  <div class="popupContent">
    ...
    <div class="rightPopup">
      <h3><?= $this->lang->line('item_cart') ?><!-- <span>$68.00</span> --></h3>
...
<div class="fixedCartbar">
    <div class="container">
          <div class="cartdetails">
             <a href="#cartPopup" onclick="document.documentElement.scrollTop = 0;" class="cartLink"><div id="cartCount" class="cartCountDown"><?= $this->cartItem; ?></div></a>
...
<script src="<?= base_url() ?>assets/front-end/js/custom/orderNow.js" type="text/javascript"></script>
<script src="<?= base_url() ?>assets/front-end/js/custom/dish.js" type="text/javascript"></script>
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <span class="nav-label">Update Manager Profile</span></div>
                ...
                <div class="panel-body">
                    <form method="post" action="<?php  echo site_url('Restaurants/editOwner/'.$owner_data[0]->user_id);?>" enctype="multipart/form-data">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                             <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <label class="control-label">First Name<i class="reustarred">*</i></label>
                                        <input class="form-control" name="fname" id="fname" placeholder="Enter First Name"  type="text" value="<?php  echo (set_value('fname'))?set_value('fname'):$owner_data[0]->first_name; ?>">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <input class="form-control" name="lname" id="lname" placeholder="Enter Last Name"  type="text" value="<?php echo (set_value('lname'))?set_value('lname'):$owner_data[0]->last_name; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control chosen-select" name="restaurant_id" id="branch">
                                     <?php 
                                         if(set_value('restaurant_id')){$branch=set_value('restaurant_id');}
                                        else {$branch=$owner_data[0]->r_id;} ?>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <input class="form-control" readonly name="email" id="email" placeholder="Enter Email"  type="text" value="<?php echo (set_value('email'))?set_value('email'):$owner_data[0]->email; ?>">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" name="contact_no" id="contact_no" placeholder="Enter Contact No."  type="text" value="<?php echo (set_value('contact_no'))?set_value('contact_no'):$owner_data[0]->contact_no; ?>" maxlength="8">
                                        </div>
                         ...
                         <div class="col-lg-12 col-md-12 col-sm-12"> 
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="form-group">
                                <input type="hidden" name="user_id" value="<?php echo $owner_data[0]->user_id;?>">

      ...
      <div class="col-md-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body table-responsive">
            ...
            <table class="table table-striped table-bordered" style="border: 1px solid #ccc;" id="basic-datatable">
              <thead>
                <tr>
                  <th>Dish Category</th>
                  <th>Dish Name</th>
                  ...
                  if(count($dishlist)>0){
                    foreach ($dishlist as $key => $value) {
                      ...
                      <tr id="dish_details_<?php echo $value->product_id; ?>">
                        ...
                        <td><?php echo stripslashes($value->product_en_name); ?></td>
                        ...
                        <td class="center"><a href="<?php echo site_url('Dishes/editDishDetail/'.$value->product_id); ?>"><i class="fa fa-edit"> </i></a> </td>
                      </tr>
                      <?php
                    }
                  }

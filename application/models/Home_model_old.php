...
class Home_model extends CI_Model
{
	...
	*/
	...
	{
		$this->db->select("od.order_id,od.order_detail_id,od.product_id,od.quantity as dishcount,ch.choice_id,chc.is_multiple,chc.choice_category_id,tbl_locality.locality_id,tbl_locality.name,tbl_locality.name_ar");
	...
	*/ 
	...
	/**  
	* Description : get  product  details of restaurant
	* Created by : Manisha Kanazariya
